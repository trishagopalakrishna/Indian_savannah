...
sand0_5_proj<-projectRaster(sand0_5, mcwd, method = 'bilinear')
sand5_15_proj<-projectRaster(sand5_15,mcwd, method = 'bilinear')
sand15_30_proj<-projectRaster(sand15_30, mcwd, method = 'bilinear')
